    ...
    <form action="/projects/store" method="POST" enctype="multipart/form-data" class="flex flex-col gap-4 mx-12 my-4">
        <div class="flex items-center gap-2">
            ...
            <div class="flex gap-2 ml-4">
                <label class="font-semibold bg-[#2A2F5A] text-white py-3 px-5 rounded-lg hover:-translate-y-0.5 hover:bg-[#454b85] hover:shadow-md transition-all cursor-pointer">
                    Add Image
                    <input type="file" name="icon" class="hidden" accept="image/*">
                </label>
                <button type="button" class="font-semibold bg-[#E8EFF7] text-[#333333] py-3 px-5 rounded-lg hover:-translate-y-0.5 hover:bg-[#cde1f7] hover:shadow-md transition-all">Delete Image</button>
            </div>
        </div>

        <div class="w-full">
            <p class="text-sm font-semibold">Project Name</p>
            <input name="name" required class="w-full mt-1 p-3 border border-[#8f8f8f] rounded-md text-[#333333] outline-none focus:border-[#2A2F5A] focus:ring-1 focus:ring-[#2A2F5A]" type="text" placeholder="Enter your project name...">
        </div>
        ...
        <div class="flex justify-end mt-2 gap-2">
            <a href="/projects" class="font-semibold bg-[#E8EFF7] text-[#333333] py-3 px-5 rounded-lg hover:-translate-y-0.5 hover:bg-[#cde1f7] hover:shadow-md transition-all text-center">Cancel</a>
            <button type="submit" class="font-semibold bg-[#2A2F5A] text-white py-3 px-5 rounded-lg hover:-translate-y-0.5 hover:bg-[#454b85] hover:shadow-md transition-all">Create Project</button>
        </div>
    </form>
</section>