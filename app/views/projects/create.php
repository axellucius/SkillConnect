<section class="ml-1">
    ...
    <form action="/projects/store" method="POST" enctype="multipart/form-data"
        ...
        <div class="flex items-center gap-2">
            <img id="project-icon-preview" src="/assets/images/default-project.jpg" alt="Default Project Image" class="h-40 w-40 rounded-full object-cover border-2 border-gray-100">
            ...
            <div class="flex gap-2 ml-4">
                <label  
                    ...
                    Add Image
                    <input type="file" name="icon" id="project-icon-input" class="hidden" accept="image/*">
                </label>
                <button type="button" id="delete-image-btn" class="font-semibold bg-[#E8EFF7] text-[#333333] py-3 px-5 rounded-lg hover:-translate-y-0.5 hover:bg-[#cde1f7] hover:shadow-md transition-all">Delete Image</button>
            </div>
        </div>
        ...
        <div class="w-full">
            ...
            <p class="text-[11px] text-gray-400 mt-1">Hold button <kbd class="bg-gray-200 px-1 rounded font-bold">Ctrl</kbd> or <kbd class="bg-gray-200 px-1 rounded font-bold">Shift</kbd>
            </p>
        </div>
